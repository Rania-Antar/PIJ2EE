...
public class GoogleCalender {
	...
	private static GoogleCalender instance;
	
	public static GoogleCalender getInstance() {
		if (instance == null) {
			instance = new GoogleCalender();
		}
		return instance;
	}
	
	
	private GoogleCalender() {
	}
...
/*	private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
	...
	public void sendEvent(Interview pfeFile, Date startDate, Date endDate, String emailStudent, String emailEntrepriseSupervisor, String emailSchoolSupervisor, String emailReporter, String emailPresident ) throws IOException, GeneralSecurityException {
